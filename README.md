<!-- <a href="https://github.com/IBM-EPBL/IBM-Project-16221-1659609760">
 <img src="">
</a> -->

<h2 align="center">Exploratory Analysis of Rainfall data for Agriculture<a href="https://github.com/IBM-EPBL/IBM-Project-17508-1659672731" target="_blank"><picture>
...
<h4 align="center">Project intended for the Agricultural Growth made with <picture>
...
<img src="https://img.shields.io/badge/IBM-052FAD.svg?style=for-the-badge&logo=IBM&logoColor=white"> 
  ...
  <a href="https://opencv.org/">
    <img src="https://img.shields.io/badge/flask-5C3EE8.svg?style=for-the-badge&logo=Flask&logoColor=white">
   </a>
...
<a href="https://github.com/othneildrew/Best-README-Template">
    <img src="https://www.promptcloud.com/wp-content/uploads/2015/01/ibm-logo.jpg" alt="Logo" width="300" height="300">
  </a>
</div> 
<p align="center">
    DOMAIN : Applied Data Science <br />
    TEAM ID    : PNT2022TMID05703 <br />
    BATCH NO   : B8-2A4E <br />  
</p>
<h2><picture>
...
<ul>
<li>Exploratory Analysis of Rainfall data for Agriculture project is simple AI & ML based website which basically shows some precautions for agriculture & provides rainfall prediction. </li>
  </ul>
<br>
...
<ul>
<li> The solution to the problem can be achieved in various approaches but one of the most reliable and effective approach is by using Machine learning methodologies, which is one of the applications of Artificial Intelligence, is being used to implement the proposed system. The irregular rainfall can be challenging for agricultural activities which depend mostly on rainfall. To overcome all these issues this rainfall prediction feature is developed in this project. Nowadays a lot of research and work is being implemented in the smart and modern agriculture domain. Exploratory Analysis is characterized by a rainfall database comprised of various attributes.</li>
  </ul>
<br>
...
<div align="center">
 <img src="https://images.squarespace-cdn.com/content/v1/5feb53185d3dab691b47361b/1609930650139-9NRI63XUJ29Y7E9LEA9G/12eca-machine-learning.gif" width="900" >
 </div>
...
<ul>
<li>In country like India, majority of the population is dependent on agriculture for their livelihood. Many new technologies, such as Machine Learning are being implemented into agriculture so that it is easier for farmers to grow and maximize their yield. This project is our small contribution to the technology driven agriculture. </ul>
<br>
...
<ul>
<li>In this system, the user can provide the climate data from their side and the application will predict will there be rainfall or not. Farmers by planning their activities with accordance to the prediction, they can avoid any wastage of yields and hence this promotes environmental friendliness.</ul><br></div><br>
...
<ul>
<li>Predicting the Rainfall in a tap is a better option in determining rainfall. By predicting the rainfall earlier, Farmers tend to reap off their crops earlier to avoid wastage. By avoiding wastage of crops, this project helps to add value for their business.</li></ul><br></div><br>
...
<ul>
<li> Exploratory Analysis of Rainfall data for agriculture is in the form of web application to provide this valuable service to Farmers.</li></ul><br></div><br>
